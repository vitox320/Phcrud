...
<html lang="pt-br">
  ...
  <header>
   ...
   <form action="Model/UserController.php?acao=inserir" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="sobrenome"  id="sobrenome" placeholder="Seu sobrenome aqui"required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Seu bairro"required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="estado"  id="estado" placeholder="Seu Estado"required>
        </div>
